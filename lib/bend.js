...
Scope.prototype.define = function(log, location, kind, name, type, modifiers) {
  var symbol, metaType, type2;
  if (this.find(name) !== null || (symbol = this.symbol) !== null && (metaType = symbol.type) instanceof MetaType && (type2 = metaType.instanceType) instanceof ClassType && (this.kind === ScopeKind.INSTANCE && type2.staticScope.find(name) !== null || this.kind === ScopeKind.STATIC && type2.instanceScope.find(name) !== null)) {
    log.error(location, "\"" + name + "\" is already defined in this scope");
  }
  var symbol2 = new Symbol(kind, name, type, this, modifiers);
...
JsNative.get = function(scope, name) {
  ...
  throw new Error("fail in src/native.bend on line 88");
};
  ...
  while (i < text.length) {
    ...
    if (code === 9) {
      ...
      if (word.length === 1) {
        ...
        throw new Error("fail in src/native.bend on line 113");
      }
